...
export class StartComponent implements OnInit {
  ...
  makroRouter = '/g-makro';
  makroImg = '../../assets/img/macro/macro11-min.jpg';
  makroTitle = 'Macro';
  makroDescription =
  ...
  produktowaImg = '../../assets/img/produktowa/produktowa5-min.jpg';
  ...
  krajobrazyImg = '../../assets/img/krajobrazy/krajobrazy6-min.jpg';
  ...
  ludzieImg = '../../assets/img/ludzie/ludzie4-min.jpg';
  ludzieTitle = 'Ludzie';
  ludzieDescription =
